<?php
    ...
    use App\StudentWebSlider;

    class StudentWebSliderController extends Controller {
        ...
        public function destroy($id){
            $slider = StudentWebSlider::find($id);

            if ($slider != null) {
                $slider = StudentWebSlider::where('id', $id)->delete();
