<?php
    ...
    class SliderController extends Controller {
        ...
        public function destroy($id){
            $slider = TeacherAppSlider::find($id);

            if ($slider != null) {
                $slider = TeacherAppSlider::where('id', $id)->delete();
